...
const articledocuments_service_1 = require("./../articledocuments/articledocuments.service");
...
ArticlesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [articles_service_1.ArticlesService, articledocuments_service_1.ArticledocumentsService],
    })
], ArticlesModule);
